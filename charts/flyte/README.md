...
| flyte.flyteadmin.image.tag | string | `"v1.1.122"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.9.5"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"f62f5c60a2f614b377204f499ff0a8c9e07571fa"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.122"` | Docker image tag |
